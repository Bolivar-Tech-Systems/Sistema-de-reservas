...
const GetRoles = async () => {
  ...
  try {
    const response = await fetch('https://129-80-171-141.nip.io/api/roles/all', {
      method: 'GET',
      headers: {
...
const CreateRole = async () => {
  ...
  try {
    const response = await fetch('https://129-80-171-141.nip.io/api/roles/create', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
...
const UpdateRole = async () => {
  ...
  try {
    const response = await fetch(`https://129-80-171-141.nip.io/api/roles/update/${editRoleData.value.id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
...
const DeleteRole = async () => {
  ...
  try {
    const response = await fetch(`https://129-80-171-141.nip.io/api/roles/delete/${roleToDelete.value.id}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
