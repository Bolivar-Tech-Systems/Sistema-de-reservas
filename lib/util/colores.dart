...
class Colores {
  ...
  static const Color primaryDark = Color.fromRGBO(
    ...
    199,
    1,
  ); // botones/fondo de CTA

  // Texto
  static const Color text = Color.fromRGBO(
    230,
    237,
    243,
    1,
  ...
  static const Color textMuted = Color.fromRGBO(
    72,
    79,
    88,
    1,
  ...
  // Iconos
  static const Color icon = Color.fromRGBO(
    139,
    148,
    158,
    1,
  ); // iconos por defecto
  static const Color iconActive = Color.fromRGBO(
    124,
    111,
    247,
    1,
